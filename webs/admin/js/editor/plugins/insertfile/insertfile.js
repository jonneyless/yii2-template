...
KindEditor.plugin('insertfile', function (K) {
    var self = this, name = 'insertfile', allowFileUpload = K.undef(self.allowFileUpload, true),
    ...
    self.plugin.fileDialog = function (options) {
        var fileUrl = K.undef(options.fileUrl, 'http://'), fileTitle = K.undef(options.fileTitle, ''),
        ...
        var dialog = self.createDialog({
            name: name, width: 450, title: self.lang(name), body: html, yesBtn: {
        ...
        var urlBox = K('[name="url"]', div), viewServerBtn = K('[name="viewServer"]', div),
            ...
            viewServerBtn.click(function (e) {
                self.loadPlugin('filemanager', function () {
                    self.plugin.filemanagerDialog({
                        viewType: 'LIST', dirName: 'file', clickFn: function (url, title) {
