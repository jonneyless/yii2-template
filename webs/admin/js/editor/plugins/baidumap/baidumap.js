...
KindEditor.plugin('baidumap', function (K) {
    ...
    self.clickToolbar(name, function () {
        ...
        var dialog = self.createDialog({
            name: name, width: mapWidth + 42, title: self.lang(name), body: html, yesBtn: {
        ...
        var div = dialog.div, addressBox = K('[name="address"]', div), searchBtn = K('[name="searchBtn"]', div),
            checkbox = K('[name="insertDynamicMap"]', dialog.div), win, doc;
