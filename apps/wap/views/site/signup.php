...
<div class="form">
    ...
    <div class="form-group">
        ...
        <div class="input input-group">
            ...
            <a id="send-vcode" class="red" href="javascript:void(0)">获取验证码</a>
        </div>
    </div>
    ...
    <div class="form-group">
        <label><?= Html::activeLabel($model, 'area_id') ?></label>
        <div class="input">
            <?= Html::activeTextInput($model, 'area', ['placeholder' => '请选择地区']) ?>
            <?= Html::activeHiddenInput($model, 'area_id') ?>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="input">
            <?= Html::activeTextInput($model, 'referee', ['placeholder' => '请输入推荐人手机号码']) ?>
        </div>
    </div>
