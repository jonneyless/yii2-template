...
<div class="tab-content">
    <div id="tab-base" class="tab-pane active">
        <div class="panel-body">
            ...
            <?= $form->field($model, 'bar_code')->textButtonInput('同步', ['maxlength' => true, 'buttonOptions' => ['id' => 'sync'], 'disabled' => !$model->goods->getIsNewRecord()]) ?>
...
HTML
            ...
            <?= $form->field($model, 'free_express')->textUnitInput('件', ['maxlength' => true])->hint('设为 0 表示不包邮') ?>
